        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10">
          <div className="max-w-[760px] reveal">
            ...
            <p className="font-display text-[clamp(22px,3vw,34px)] leading-[1.2] tracking-[-0.015em] text-obsidian dark:text-bone mb-6 max-w-[640px] text-balance">
              Monthly partnership options — or a one-off payment.
            </p>
            <p className="text-lg md:text-xl text-graphite max-w-[560px]">
              Fixed prices. No "starting at." No hidden hourly fees. Pick the
              partnership that fits, or book a one-off when you only need one
              connection done.
            </p>
          </div>
        </div>
